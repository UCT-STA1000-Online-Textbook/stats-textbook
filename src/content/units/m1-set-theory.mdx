...
quiz:
  ...
  - id: "q2"
    ...
    answer: false
    explanation: "False. The relative frequency only tends toward the true probability as a limit — any finite run will almost certainly show some deviation. Click 'Run trials yourself' and add 100 trials at a time: r/n converges on the dashed line without ever locking to it permanently."
  - id: "q3"
    type: "mcq"
...
<TryThis
  vizId="relative-frequency"
  params={{ experiment: "coin" }}
  label="Run trials yourself"
  description="Add 1, 10 or 100 trials at a time and watch r/n drift toward the dashed line at the true probability. Try the die experiment too — the convergence is much slower because Pr(roll a 6) is only 1/6."
/>
