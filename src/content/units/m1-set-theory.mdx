...
<TryThis
  ...
  description="Flip a fair coin or roll a fair die — throw it yourself or simulate hundreds of trials at once. Watch each outcome's relative frequency settle toward the theoretical probability; the more trials you run, the closer the bars get to the dashed line. Use the toggle at the top to switch between the coin and the die."
/>
